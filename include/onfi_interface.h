...
public:
    ...
    */
    void read_page(unsigned int my_block_number, unsigned int my_page_number, uint8_t address_length = 5,
                   bool verbose = false);
    ...
    */
    void partial_erase_block(unsigned int my_block_number, unsigned int my_page_number, uint32_t loop_count = 30000,
                             bool verbose = false);
    ...
    */
    bool verify_block_erase(unsigned int my_block_number, bool complete_block = false,
                            uint16_t *page_indices = page_indices_selected, uint16_t num_pages = num_pages_selected,
                            bool verbose = false);
    ...
    */
    void program_page(unsigned int my_block_number, unsigned int my_page_number, uint8_t *data_to_program,
                      bool including_spare = true, bool verbose = false);

    void partial_program_page(unsigned int my_block_number, unsigned int my_page_number, uint32_t loop_count,
                              uint8_t *data_to_program, bool including_spare = true, bool verbose = false);
    ...
    */
    void program_page_tlc_toshiba(unsigned int my_block_number, unsigned int my_page_number, uint8_t *data_to_program,
                                  bool including_spare = true, bool verbose = false);

    void program_page_tlc_toshiba_subpage(unsigned int my_block_number, unsigned int my_page_number,
                                          unsigned int subpage_number, uint8_t *data_to_program,
                                          bool including_spare = true, bool verbose = false);
    ...
    .. verbose is for priting messages
    */
    bool verify_program_page(unsigned int my_block_number, unsigned int my_page_number, uint8_t *data_to_program,
                             bool verbose = false);
    ...
    */
    void program_pages_in_a_block(unsigned int my_block_number, bool complete_block, bool data_random,
    ...
    /**
        ...
        .. verbose is for printing
    */
    void program_pages_in_a_block_data(unsigned int my_block_number, uint8_t *provided_data,
                                       bool complete_block = false, uint16_t *page_indices = page_indices_selected,
                                       uint16_t num_pages = num_pages_selected, bool verbose = false);
    ...
    /**
        ...
        */
    void program_n_pages_in_a_block(unsigned int my_block_number, uint16_t num_pages = 512, bool array_provided = false,
                                    uint8_t *provided_array = NULL, bool verbose = false);
    ...
    */
    ...
    void partial_program_pages_in_a_block(unsigned int my_block_number, uint32_t loop_count, bool complete_block,
                                          uint16_t *page_indices, uint16_t num_pages, bool verbose);
    ...
    /**
        ...
        .. verbose is for printing
        */
    bool verify_program_pages_in_a_block(unsigned int my_block_number, bool complete_block, uint16_t *page_indices,
    ...
    */
    void read_and_spit_page(unsigned int my_block_number, unsigned int my_page_number, bool bytewise = false,
                            bool verbose = false);
    ...
    each value is hex while the sequence is terminated by newline character
    */
    void read_and_spit_page_tlc_toshiba(unsigned int my_block_number, unsigned int my_page_number,
                                        bool verbose = false);
    ...
    */
    void read_block_data(unsigned int my_block_number, unsigned int my_page_number, bool complete_block = false,
                         uint16_t *page_indices = page_indices_selected, uint16_t num_pages = num_pages_selected,
                         bool verbose = false);
   ...
   */
    void read_page_and_return_value(unsigned int my_block_number, unsigned int my_page_number, uint16_t index,
                                    uint8_t *return_value, bool including_spare = true);
    ...
    .. verbose indicates the debug messages to be printed
    */
    void read_block_data_n_pages(unsigned int my_block_number, uint16_t num_pages = 1, bool bytewise = false,
                                 bool verbose = false);
    ...
    */
    void convert_pagenumber_to_columnrow_address(unsigned int my_block_number, unsigned int my_page_number,
