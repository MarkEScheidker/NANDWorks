...
#if DEBUG_ONFI
	if(onfi_debug_file)
               onfi_debug_file<<"I: Converting to virtual successful. The base address is 0x"<<std::hex<<reinterpret_cast<uintptr_t>(bridge_base_virtual)<<endl;
	else
               cout<<"I: Converting to virtual successful. The base address is 0x"<<std::hex<<reinterpret_cast<uintptr_t>(bridge_base_virtual)<<endl;
#else
       if(verbose) cout<<"I: Converting to virtual successful. The base address is 0x"<<std::hex<<reinterpret_cast<uintptr_t>(bridge_base_virtual)<<endl;
#endif
	}
